...
function ColorPicker() {
	...
	cp_contents += "<TABLE BORDER=5  CELLSPACING=0 CELLPADDING=0>";
	...
	if (document.getElementById) {
		...
		cp_contents += "<TR><TD COLSPAN='"+width1+"' BGCOLOR='#ffffff' ID='colorPickerSelectedColor'>&nbsp;</TD><TD bgcolor='white' COLSPAN='"+width2+"' ALIGN='CENTER' ID='colorPickerSelectedColorValue' style='font-family:arial;font-size:12px'> #FFFFFF</TD></TR>";
		}
	cp_contents += "</TABLE>";
	if (windowMode) {
