<?
$usetitle = "Report - Drivers Active Insurance";
$use_title = "Report - Drivers Active Insurance";
?>
<? include('header.php') ?>
<?
	...
	*/
	...
	$uuid = createuuid();
	$excel_filename = "report_drivers_active_insur_$uuid.xls";
	$export_file = "";
	$use_excel=1;
	$mrr_use_styles=0;	
	...
	$headerx=" style='background-color:#CCCCFF;'";
 	...
 	{ 	
		...
		$export_file .= "Report - Drivers Active Insurance".chr(9).
			"".chr(9).
			"".chr(9).
			"".chr(9).
			"".chr(9).
	...
	&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <i>Use this report to find those who ARE marked as active right now.  Dispatches within the selected date range will show up if any.</i><br><br>
