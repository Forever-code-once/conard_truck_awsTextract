<? $usetitle = "Report - Owner Operators" ?>
<? include('header.php') ?>
<?
	$use_title = "Report - Owner Operator";
...
<? if(isset($_POST['build_report'])) { ?>
	...
	function show_driver_totals($truck_id=0,$driver_id=0) 
	{
		...
		//Find Fuel expenses
		$ooic_expenses=0;
		if($truck_id > 0 || $driver_id > 0)		$ooic_expenses=mrr_pull_income_fuel_exp($truck_id,$driver_id,$_POST['date_from'],$_POST['date_to']);
				
		$grand_tot_ooic+=$mrr_driver_pay_ooic;
		$grand_tot_ooic_expenses+=$ooic_expenses;
		...
		if($driver_pay_ooic != 0) 
		{
			...
			echo "
				<tr style='background-color:#d0deff'>
					...
					<td align='right'>$".money_format('',$ooic_expenses)."</td>
					<td align='right'>&nbsp;</td>
					<td align='right'>&nbsp;</td>
					<td align='right'>&nbsp;</td>
					...
					<td colspan='11'><b>< - - From Income Statement Chart 58800</b></td>
				</tr>	
			";
		}
	...
	<tr>
		<td colspan='16'>
			<center>
			<span class='section_heading'>Owner Operator Report</span>
			<br>
			<?= $print_header_label ?>
			</center>
			<br>
...
<script type='text/javascript'>
    ...
    function mrr_ooic_auto_update_route(id,x)
    {
