...
<?
	$mrr_save_preloader=0;
     ...
     //{
     	$mrr_save_preloader=1;
     	$mrr_run_preloader=0;
     	$sql="delete from load_board";         	simple_query($sql);			//purge all until ready to use it...
     //}
?>
				...
				$.ajax({
          			...
          			success: function(xml) {
          				...
          				*/
          				...
          				$('.avail_driver_'+myid+'').html(mytext2 + "<br>" + mytext);				
          			}
          		});	
			}
		});		
				...
				$.ajax({
          			...
          			success: function(xml) {
          				...
          				*/
          				...
          				$('.preplan_driver_'+myid+'').html(mytext2 + "<br>" + mytext);				
          			}
          		});	
			}
		});
