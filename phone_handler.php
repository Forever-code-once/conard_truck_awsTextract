...
{	//test mode	
	...
	$_POST['From']="6159699115";	//"+16159697701";	//"+16154592921";		//"+16159575407";		
	$_POST['Body']="This is Just a Dispatcher Reply Test.";
}
...
{	//NEW response to forward reply txt msg from dispatch to driver, or back.
	...
	if($from=="6159699115")
	{
		$res=send_twilio_messages($from, "".$from." Reply: ".$msg."");	
	}
	elseif($reply_mode==2)
	{	//came from a driver, so send to all dispatch numbers
		$sql="
     		select id, name_first,name_last,txt_msg_reply_phone
     		from users
     		where active>0 
     	...
     	{	
     		...
     		$res=send_twilio_messages($phone_number, "".$from." Reply: ".$msg."");	
     	}
	}
}
else
