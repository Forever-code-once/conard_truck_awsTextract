<? $usetitle="Sales Report - By Driver"; ?>
<? include('header.php') ?>
<?
 	...
 	{ 
        ...
        */
		...
		$sql = "
			...
			order by drivers.name_driver_last, drivers.name_driver_first, load_handler.id, trucks.name_truck			
	...
	<? 
		...
		while($row = mysqli_fetch_array($data)) 
		{
			...
			if($last_driver_id != $row['driver_id']) 
			{				
				if($last_driver_id > 0) echo "<tr><td colspan='18'><hr></td></tr>";
				...
				echo "
					<tr class='odd' style='font-size:14px;font-weight:bold'>
						...
						<td colspan='3'><i><b>Sales may be split across drivers</b></i></td>
