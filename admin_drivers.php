...
{	//SAVE DRIVER FORM
    ...
    $use_started = '';
    $use_license_expires = '';
    $use_cdl_certified = ''; //added 18 May 2025
    $use_cov_expires = '';
    $use_terminated='';
    $use_review_due='';
    $use_spouse='';
    ...
    if($_POST['linedate_cdl_certified'] != '')   $use_cdl_certified = date("Y-m-d", strtotime($_POST['linedate_cdl_certified'])); //added 18 may 2025
    ...
    $sql = "
			update drivers set
				...
				linedate_cdl_certified = '".($use_cdl_certified == '' ? '0000-00-00 00:00:00' : sql_friendly($use_cdl_certified))."',
...
<table class='admin_menu1' style='text-align:left'>
    <tr>
        ...
        <td valign='top' style='width:350px'>
			...
			-->
                        ...
                        <tr>
                            ...
                            <td colspan='2'>
                                <?php  if(!isset($row_edit['jit_driver_flag']))		$row_edit['jit_driver_flag']=0;	?>
                        ...
                        <tr>
                            <td><b>CDL Certified Date</b> <?= show_help('admin_drivers.php','linedate_cdl_certified') ?></td>
                            <td colspan='2'><input name="linedate_cdl_certified" id='linedate_cdl_certified' value="<? if(strtotime($row_edit['linedate_cdl_certified']) != 0) echo date("m/d/Y", strtotime($row_edit['linedate_cdl_certified'])) ?>"> (mm/dd/yyyy)</td>
                        </tr>
                        <tr>
                ...
                <div id='employer_section'>
                    ...
                    <?php if($use_admin_level >= $driver_admin_min) { ?>
        ...
        ?>
        <td valign='top'>
            <?php if($_GET['id'] > 0 && $use_admin_level >= $driver_admin_min) { ?>
...
<script type='text/javascript'>
    ...
    $('#linedate_cdl_certified').datepicker();
