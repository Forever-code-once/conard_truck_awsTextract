<?
$usetitle="Broker/Customer Loading Report";  
?>
<? include('header.php') ?>
...
<?
	...
	$sql = "
		...
		where load_handler_stops.deleted = 0
			...
			and load_handler_stops.stop_type_id=1
...
<div style='margin-left:30px;margin-top:10px;'>
	<h3><?=$usetitle ?></h3><br><span class='alert'><b>Please use the Date From, Date To, City, and State value to find Broker/Customer shipper stops in that area.</b></span> All other filters are optional but may narrow the focus.<br>
</div>
<!--		
	<br><?=$sql ?><br>
-->
			...
			*/
			echo "
     			<tr class='load_".$row['load_handler_id']."'>
     				...
     				<td nowrap>".trim($row['contact_primary'])."</td>
     				<td nowrap>".trim($row['contact_email'])."</td>
     				<td nowrap>".trim($row['phone_work'])."</td>     				
