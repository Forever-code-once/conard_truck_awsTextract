<?
$usetitle = "Report - Dispatch Summary";
$use_title = "Report - Dispatch Summary";
?>
<? include('header.php') ?>
<?
	...
	if(!isset($_POST['mrr_show_num_haul1_max']))		$_POST['mrr_show_num_haul1_max']=375;
	if(!isset($_POST['mrr_show_num_range1_min']))
	{
		$_POST['mrr_show_num_range1_min']=0;
		$_POST['mrr_show_num_range1_max']=375;
			
		$_POST['mrr_show_num_range2_min']=376;
		$_POST['mrr_show_num_range2_max']=575;
			
		$_POST['mrr_show_num_range3_min']=576;
		$_POST['mrr_show_num_range3_max']=0;
			
		$_POST['mrr_show_num_range4_min']=0;
		$_POST['mrr_show_num_range4_max']=0;
			
		$_POST['mrr_show_num_range5_min']=0;
		$_POST['mrr_show_num_range5_max']=0;	
		
		$_POST['summary_only']=1;
	}
	...
	$rfilter->mrr_show_num_range1		= true;
	$rfilter->mrr_show_num_range2		= true;
	$rfilter->mrr_show_num_range3		= true;
	$rfilter->mrr_show_num_range4		= true;
	$rfilter->mrr_show_num_range5		= true;
	
	$rfilter->mrr_show_num_haul1		= true;
	//$rfilter->mrr_show_num_haul2	= true;
	...
	$range_1=0;		//Group 1 variable range
	$range_2=0;		//Group 2 variable range
	$range_3=0;		//Group 3 variable range
	$range_4=0;		//Group 4 variable range
	$range_5=0;		//Group 5 variable range
	...
	<?
		...
		while($row = mysqli_fetch_array($data)) 
		{
			...
			echo "
				<tr class='".($counter % 2 == 1 ? 'odd' : 'even')." mrr_table_row'>
			...
			if(($vmiles + $dhmiles) > $_POST['mrr_show_num_haul1_max'])
			{				
				$long_haul++;
			}
			else
			...
			$min_1=((int) trim($_POST['mrr_show_num_range1_min']));			$max_1=((int) trim($_POST['mrr_show_num_range1_max']));			if($max_1==0 && $min_1 >= 0)		$max_1=999999;
			$min_2=((int) trim($_POST['mrr_show_num_range2_min']));			$max_2=((int) trim($_POST['mrr_show_num_range2_max']));			if($max_2==0 && $min_2 > 0)		$max_2=999999;
			$min_3=((int) trim($_POST['mrr_show_num_range3_min']));			$max_3=((int) trim($_POST['mrr_show_num_range3_max']));			if($max_3==0 && $min_3 > 0)		$max_3=999999;
			$min_4=((int) trim($_POST['mrr_show_num_range4_min']));			$max_4=((int) trim($_POST['mrr_show_num_range4_max']));			if($max_4==0 && $min_4 > 0)		$max_4=999999;
			$min_5=((int) trim($_POST['mrr_show_num_range5_min']));			$max_5=((int) trim($_POST['mrr_show_num_range5_max']));			if($max_5==0 && $min_5 > 0)		$max_5=999999;
			
			
			if($min_1 >= 0 && ($vmiles + $dhmiles) >= $min_1 && ($vmiles + $dhmiles) <= $max_1)		$range_1++;
			if($min_2 > 0 && ($vmiles + $dhmiles) >= $min_2 && ($vmiles + $dhmiles) <= $max_2)		$range_2++;
			if($min_3 > 0 && ($vmiles + $dhmiles) >= $min_3 && ($vmiles + $dhmiles) <= $max_3)		$range_3++;
			if($min_4 > 0 && ($vmiles + $dhmiles) >= $min_4 && ($vmiles + $dhmiles) <= $max_4)		$range_4++;
			if($min_5 > 0 && ($vmiles + $dhmiles) >= $min_5 && ($vmiles + $dhmiles) <= $max_5)		$range_5++;
			...
			if(isset($_POST['show_stops']) || $show_this_set_of_stops==1) {
				...
				while($row_stop = mysqli_fetch_array($data_stops)) {
					...
					echo "
						<tr class='mrr_table_row' style='background-color:#e2ffe4'>
		...
		if($range_all>0)
		{
			...
			$percent_1= $range_1 / $range_all * 100;
			$percent_2= $range_2 / $range_all * 100;
			$percent_3= $range_3 / $range_all * 100;
			$percent_4= $range_4 / $range_all * 100;
			$percent_5= $range_5 / $range_all * 100;
		}	
	?>
	</tbody>
	<tfoot>
	...
	<tr>
		<td>&nbsp;</td>
		<td colspan='6'><span class='mrr_link_like_on' onClick='mrr_toggle_table_rows();'>Details (may take a while)</span></td>
		<td colspan='6'><?=number_format($short_haul)?> short haul(s) <span class='alert'>0 - <?=((int) trim($_POST['mrr_show_num_haul1_max'])) ?></span> out of <?= $total_haul ?></td>
	...
	<tr>
		<td>&nbsp;</td>
		<td colspan='6'>&nbsp;</td>
		<td colspan='6'><?=number_format($long_haul)?> long haul(s) <span class='alert'><?=((int) trim($_POST['mrr_show_num_haul1_max']) + 1) ?>+</span> out of <?= $total_haul ?></td>
	...
	<? if (((int) trim($_POST['mrr_show_num_range1_min'])) > 0 || ((int) trim($_POST['mrr_show_num_range1_max'])) > 0) { ?>	
	<tr>
		<td>&nbsp;</td>
		<td colspan='6'><b>Radius of Operations</b></td>
		<td colspan='6'><?=number_format($range_1)?> Loaded Mile haul(s) <span class='alert'><?=((int) trim($_POST['mrr_show_num_range1_min'])) ?> - <?=((int) trim($_POST['mrr_show_num_range1_max'])) ?></span> out of <?= $range_all ?></td>
		<td align='right'><?=number_format($percent_1,2)?>%</td>
		<td align='right'>&nbsp;</td>
		<td>&nbsp;</td>
	</tr>
	<? } ?>
	<? if (((int) trim($_POST['mrr_show_num_range2_min'])) > 0 || ((int) trim($_POST['mrr_show_num_range2_max'])) > 0) { ?>	
	<tr>
		<td>&nbsp;</td>
		<td colspan='6'><b>&nbsp;</b></td>
		<td colspan='6'><?=number_format($range_2)?> Loaded Mile haul(s) <span class='alert'><?=((int) trim($_POST['mrr_show_num_range2_min'])) ?> - <?=((int) trim($_POST['mrr_show_num_range2_max'])) ?></span> out of <?= $range_all ?></td>
		<td align='right'><?=number_format($percent_2,2)?>%</td>
		<td align='right'>&nbsp;</td>
		<td>&nbsp;</td>
	</tr>
	<? } ?>
	<? if (((int) trim($_POST['mrr_show_num_range3_min'])) > 0 || ((int) trim($_POST['mrr_show_num_range3_max'])) > 0) { ?>	
	<tr>
		<td>&nbsp;</td>
		<td colspan='6'><b>&nbsp;</b></td>
		<td colspan='6'><?=number_format($range_3)?> Loaded Mile haul(s) <span class='alert'><?=((int) trim($_POST['mrr_show_num_range3_min'])) ?> - <?=((int) trim($_POST['mrr_show_num_range3_max'])) ?></span> out of <?= $range_all ?></td>
		<td align='right'><?=number_format($percent_3,2)?>%</td>
		<td align='right'>&nbsp;</td>
		<td>&nbsp;</td>
	</tr>
	<? } ?>
	<? if (((int) trim($_POST['mrr_show_num_range4_min'])) > 0 || ((int) trim($_POST['mrr_show_num_range4_max'])) > 0) { ?>	
	<tr>
		<td>&nbsp;</td>
		<td colspan='6'><b>&nbsp;</b></td>
		<td colspan='6'><?=number_format($range_4)?> Loaded Mile haul(s) <span class='alert'><?=((int) trim($_POST['mrr_show_num_range4_min'])) ?> - <?=((int) trim($_POST['mrr_show_num_range4_max'])) ?></span> out of <?= $range_all ?></td>
		<td align='right'><?=number_format($percent_4,2)?>%</td>
		<td align='right'>&nbsp;</td>
		<td>&nbsp;</td>
	</tr>
	<? } ?>
	<? if (((int) trim($_POST['mrr_show_num_range5_min'])) > 0 || ((int) trim($_POST['mrr_show_num_range5_max'])) > 0) { ?>	
	<tr>
		<td>&nbsp;</td>
		<td colspan='6'><b>&nbsp;</b></td>
		<td colspan='6'><?=number_format($range_5)?> Loaded Mile haul(s) <span class='alert'><?=((int) trim($_POST['mrr_show_num_range5_min'])) ?> - <?=((int) trim($_POST['mrr_show_num_range5_max'])) ?></span> out of <?= $range_all ?></td>
		<td align='right'><?=number_format($percent_5,2)?>%</td>
		<td align='right'>&nbsp;</td>
		<td>&nbsp;</td>
	</tr>
	<? } ?>
	...
	<tr>
		<td>&nbsp;</td>
		<td colspan='6'>&nbsp;</td>
		<td colspan='6'><?=number_format($short_haul)?> short haul(s) <span class='alert'>0 - 375</span> out of <?= $total_haul ?></td>
		<td align='right'><?=number_format($short_percent_haul,2)?>%</td>
		<td align='right'>&nbsp;</td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td colspan='6'>&nbsp;</td>
		<td colspan='6'><?=number_format($long_haul)?> long haul(s) <span class='alert'>376+</span> out of <?= $total_haul ?></td>
		<td align='right'><?=number_format($long_percent_haul,2)?>%</td>
		<td align='right'>&nbsp;</td>
		<td>&nbsp;</td>
	</tr>
...
<script type='text/javascript'>
	...
	function mrr_toggle_table_rows()
	{
		if(details_on==0)
		{
			//$.prompt("Showing Details... may take a few moments...");	
			$('.mrr_table_row').show();
			details_on=1;
		}
		else
		{
			if(details_on==1)
			{
				//$.prompt("Hiding Details... may take a few moments...");	
				$('.mrr_table_row').hide();
				details_on=0;	
			}
		}
