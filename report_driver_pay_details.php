...
<?
	...
	$uuid = createuuid();
	$excel_filename = "driver_pay_$uuid.xls";
	$export_file = "";
	$use_excel=1;
	
		if(isset($_POST['build_report'])) {
			
			$export_file .= "Driver Pay Details".chr(9).
     			"".chr(9).
     			"".chr(9).
     			"".chr(9).
     			"".chr(9).
			...
			echo "
				<div style='float:left;margin:0 0 10px 30px' class='section_heading'>Driver Pay Details</div>
		...
		echo "
			...
			<br>".$cntr." Drivers Found (<b>".$acntr." Active</b> and ".$icntr." Inactive).
		";
		
		$export_file .= chr(13);	
		$export_file .= chr(13);	
		$export_file .= "".$cntr." Drivers Found (".$acntr." Active and ".$icntr." Inactive).".chr(9).
     			"".chr(9).
     			"".chr(9).
     			"".chr(9).
     			"".chr(9).
