<?
$usetitle="PeopleNet Activity Report";  
?>
<? include('header.php') ?>
<?
	...
	//$rep_val=mrr_super_repair_pc_miler_app();		//renew the PC Miler license...
...
<div style='margin-left:30px;margin-top:10px;display:inline;float:left;clear:right'>
	<h3>Peoplenet Geofencing Activity Messages</h3>
...
<? 
	...
	$full_report=mrr_pull_all_active_geofencing_rows_alt1(0);
	echo $full_report;
?>
</tbody>
</table>
...
<script type='text/javascript'>
	...
	$().ready(function() {
     			...
     			submit: function(v, m, f) {
     				...
     				{     					
     					$.ajax({
     						...
     						data: {
     							"mode":1,
     							"page": "report_peoplenet_activity.php"
     						},
		...
		<? } ?>		
		setTimeout("location.reload();", (60 * 2000));		//ten minutes...600 seconds...1000=1 second
	});
